...
if (!isset($_SESSION['settings'])) {
  ...
  $_SESSION['settings']['start_bait'] = intval($_POST['start_bait']);
  $_SESSION['settings']['end_bait'] = intval($_POST['end_bait']);
  $_SESSION['settings']['mode'] = $_POST['mode'];
  $_SESSION['settings']['tipe'] = $_POST['tipe'];
  $_SESSION['settings']['salahjawab'] = [];
  if (!isset($_SESSION['settings']['baitsoal'])) {
    $_SESSION['settings']['baitsoal'] = intval($_POST['start_bait']);
  } else {
    $_SESSION['settings']['baitsoal'] = intval($_SESSION['settings']['baitsoal']) + 1;
  }
  if (!isset($_SESSION['settings']['soal'])) {
    $_SESSION['settings']['soal'] = "";
  }
  if ($_POST['tipe'] === 'umum') {
...
$correctQuestion = intval($_SESSION['settings']['baitsoal']);
$correctAnswer = $correctQuestion + 1;
...
$sqlcorrectanswers = "SELECT " . $satar . " FROM bait WHERE no_bait = {$correctAnswer}";
...
<body>
  <form id="quizForm" action="modelalaran.php" method="post">
